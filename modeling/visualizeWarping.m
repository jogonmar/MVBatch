function visualizeWarping(warpnoc,band,warptest,tg,nsamplesToPlot,plotallFlag,axes1)
...
%
%  visualizeWarping(warpnoc,band)                                                    % call to build the NOCWI control chart.
%  visualizeWarping(warpnoc,band,warptest)                                           % call to build the NOCWI control chart and display the WI profile of a test batch with the default values.
%  visualizeWarping(warpnoc,band,warptest,tg,nsamplesToPlot,plotallFlag,axes1)       % complete call
%
% INPUTS:
%
